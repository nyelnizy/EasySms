...
namespace Sguy\EasySms\SmsOnlineGh;
    ...
    use Sguy\EasySms\SmsOnlineGh\SMSResponse;
 ...
 //   use Zenoph\ZenophSMSGH\Enums;
    ...
    class ZenophSMSGH {
        ...
        public function __construct() {
            ...
            $this->message = null;
            $this->senderid = null;
            $this->msgtype  = MessageTypes::TEXT;
            $this->destinations = [];
        ...
        private function isValidMessageType($msgtype){
            ...
            switch ($msgtype){
                ...
                case MessageTypes::FLASH_TEXT:
                case MessageTypes::UNICODE:
                case MessageTypes::FLASH_UNICODE:
                    return true;
        ...
        private function validateSenderId($senderid){
            ...
            if (self::isValidPhoneNumber($senderid)){    // phone number as sender id
                if (strlen($senderid) > self::NUMERIC_MessageTypes_MAX_LEN)
         ...
         * @throws ZenophSMSGHException  Thrown if server request fails.<br />
         ...
         * </code><br />
         * <p>
         * When {@link sendMessage()} is called, it returns an object of type {@link ResponseCodes}. The
        ...
        private function processSubmitResponse($resp, $cleardests){
            ...
            if ($response[0] != ResponseCodes::SUCCESS)  // not successful.
                throw new ZenophSMSGHException($response[1], $response[0]);
           ...
           // check to see if we have a token response or not.
            if (substr_count($response[1], '|') == 0)
                return new ResponseCodes(true, $response[1]);
            else {
                ...
                return new ResponseCodes(false, $submitresp);
            }
        }
         ...
         * @throws ZenophSMSGHException Thrown if request fails.
         * <p></p><br />
